	...
	<!-- Component Start -->
	<div class="barralateral w-60 overflow-hidden mt-3 rounded position-fixed">
		...
		<div class="w-full px-2">
			...
			<div class="flex flex-col items-center w-full mt-2 border-t border-gray-300">
				<a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-300" href="/estrategicos">
				...
				<a class="flex items-center w-full h-12 px-3 mt-2 bg-gray-300 rounded" href="#">
					...
					<span class="ml-2 text-sm font-medium">Reporte Estrategico 3</span>
				</a>
			...
			<div class="flex flex-col items-center w-full mt-2 border-t border-gray-300">
				...
				<a class="relative flex items-center w-full h-12 px-3 mt-2 mb-2 rounded hover:bg-gray-300" href="#">
					<svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
